...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        const stockHistoryDays = parseInt(event.queryStringParameters?.stockHistoryDays) || 30;
        const stockChangesDays = parseInt(event.queryStringParameters?.stockChangesDays) || 7;
